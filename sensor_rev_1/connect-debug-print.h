...
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS)
#define emberAfPluginWstkSensorsPrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS, __VA_ARGS__)
#define emberAfPluginWstkSensorsPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginWstkSensorsFlush()
#define emberAfPluginWstkSensorsDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS) ) { x; }
#define emberAfPluginWstkSensorsPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS, (buffer), (len), (withSpace))
#define emberAfPluginWstkSensorsPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS, (buffer))
#else
#define emberAfPluginWstkSensorsPrint(...)
#define emberAfPluginWstkSensorsPrintln(...)
#define emberAfPluginWstkSensorsFlush()
#define emberAfPluginWstkSensorsDebugExec(x)
#define emberAfPluginWstkSensorsPrintBuffer(buffer, len, withSpace)
#define emberAfPluginWstkSensorsPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_WSTK_SENSORS)
